...
define('DOMAIN_URL', 'https://www.arrowfurnitures.in/admin/'); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
...
class Database
{
    ...
    private $db_user = "arrowfurnitures_admin";  // Change as required
    private $db_pass = "Admin@2022";  // Change as required
    private $db_name = "arrowfurnitures_admin";    // Change as required
